...
| Time          | Module                              |
|---------------|-------------------------------------|
| 9:00 - 09:15   | [Quarto Setup](1-setup/)   |
| 9:15 - 09:40   | [Intro](https://docs.google.com/presentation/d/1KHqNdHdBSoUYa8QoMfhRS-R5hzqhBiOqdffqOA-jml8/edit?usp=sharing)   |
| 9:40 - 10:10   | [Quarto Basics](3-basics/)   |
...
| Time        | Module                                        |
|-------------|-----------------------------------------------|
| 1:15 - 1:45 | [Slides in Quarto](4-slides/) w/ Emil Hansen|
| 1:45 - 1:55 | 10 min break                                  |
| 1:55 - 2:20  | [nbdev](https://nbdev.fast.ai) w/Hamel Husain |
| 2:20 - 2:30 | 10 min break                                  |
| 2:30 - 3:20 | [ShinyLive For Python](https://shiny.posit.co/py/docs/shinylive.html) w/Gordon Shotwell |
| 3:20 - 3:30 | 10 min break                           |
| 3:30 - 4:20 | [Quartodoc](https://github.com/machow/quartodoc) w/Michael Chow              |
